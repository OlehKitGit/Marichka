...
# Конфигурация
BOT_TOKEN = "7972289518:AAEblUtyP0Mm7vubQ1arUGqiMymds6rjl-k"  # Замените на токен бота
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
   ...
   # else:
    await update.message.reply_text("✅ Тримай усю правду!")
    return
...
async def handle_photo(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    tarot_dir = Path('/root/paintings/venv311/Tarot')
...
def main() -> None:
    ...
    TOKEN = "7972289518:AAEblUtyP0Mm7vubQ1arUGqiMymds6rjl-k"
